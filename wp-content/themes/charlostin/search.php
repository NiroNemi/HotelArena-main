...
<?php } ?>
    <div class="container">
        <div class="breadcrumb_text">
            <h2 class="title-center"><?php printf( esc_html__( 'Search Results for: %s', 'charlostin' ), get_search_query() ); ?></h2>
        </div>
    </div>
</section>
            <!-- End Intro Section -->
            ...
            <div class="col-lg-8">
                <div class="blog_item_inner">
                    ...
                    <?php endwhile; else :?>
                                ...
                                echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'charlostin' ) ;?></h4>
