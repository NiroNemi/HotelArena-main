...
<?php } ?>
            <div class="container">
                <div class="breadcrumb_text">
                    <h2 class="title-center"><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'charlostin' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'charlostin' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'charlostin' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'charlostin' ), get_the_date( _x( 'Y', 'yearly archives date format', 'charlostin' ) ) );

                        else :
                            echo esc_html__( 'Archives', 'charlostin' );
